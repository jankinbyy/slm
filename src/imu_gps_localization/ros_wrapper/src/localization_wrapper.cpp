...
LocalizationWrapper::LocalizationWrapper(ros::NodeHandle &nh) {
    ...
    std::string log_folder = "/home/jankin/linux/slam/eskf/eskf_ws/log";
    ...
    // Subscribe topics.
    imu_sub_ = nh.subscribe("/Ser_imu", 10, &LocalizationWrapper::ImuCallback, this);
    gps_position_sub_ = nh.subscribe("/GPS_fix", 10, &LocalizationWrapper::GpsPositionCallback, this);
